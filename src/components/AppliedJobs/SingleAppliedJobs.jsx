...
const SingleAppliedJobs = ({ singleStoredJobs }) => {
    const { company_logo, title, company_name, placement, duty, salary, location, id } = singleStoredJobs;


    return (
        <div className='border shadow rounded p-8 md:flex justify-between'>
            <div className='md:flex justify-between gap-8'>
                <div className='flex items-center justify-center md:w-60 h-56 md:h-60 bg-[#F4F4F4] p-4'>
